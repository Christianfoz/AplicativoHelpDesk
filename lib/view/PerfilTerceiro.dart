                        ...
                        children: [
                          ...
                          // verifica se é técnico, caso seja não aparecerá a parte de seção de chamados criados
                           widget._perfilUtil.pessoaPerfil.tipoPessoa
                              ...
                              : StreamBuilder(
                                      builder: (context,
                                          AsyncSnapshot<List<Ordem>> snapshot) {
                                                              ...
                                                              children: [
                                                                ...
                                                                Padding(
                                                                  child: Align(
                                                                      ...
                                                                      child: Text(
                                                                          "Criado em " +
                                                                              DateFormat(DateFormat.YEAR_MONTH_DAY, 'pt_Br').format(ordem
                                                                                  .dataInicio) +
                                                                              " as " +
                                                                              DateFormat('HH:mm', 'pt_Br').format(ordem
                                                                                  .dataInicio),
                                                                          maxLines:
                                                                              1,
                                                                          style:
